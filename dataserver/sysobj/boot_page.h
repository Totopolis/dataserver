...
//
#pragma once
#ifndef __SDL_SYSOBJ_BOOT_PAGE_H__
#define __SDL_SYSOBJ_BOOT_PAGE_H__
...
struct bootpage_row
{
    struct data_type {
        ...
        uint8       _0x1AC[16];                     // 00x1AC : ? ? -16 bytes - value 0
...
#endif // __SDL_SYSOBJ_BOOT_PAGE_H__
